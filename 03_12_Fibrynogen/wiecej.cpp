...
int main(int argc, char **argv)
{
    ...
    fb1.r[22]=6.7/2.0;
    for(int i=23;i<47;i++) fb1.r[i]=1.5/2.0;

    for(int i=0; i<23; i++) fb1.y[i]=0.0;
    for(int i=0; i<12; i++) fb1.y[i+23]=-4.0843982621761565-1.4942920471376184*i;
    for(int i=0; i<12; i++) fb1.y[i+35]=-4.0843982621761565-1.4942920471376184*i;
    ...
    fb1.x[22]=21.0;
    for(int i=0; i<11; i++) fb1.x[i+23]=-21.3573385452654-0.13073361412148726*i;
    for(int i=0; i<11; i++) fb1.x[i+35]=21.3573385452654+0.13073361412148726*i;
